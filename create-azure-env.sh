...
imageName=$registryUrl/azure-source-expedia-connector:1.0.0
docker build -t $imageName -f connectors/Dockerfile .

echo "Pushing Docker image '$imageName' to the remote registry..."
